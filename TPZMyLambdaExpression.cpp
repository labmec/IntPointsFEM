...
TPZMyLambdaExpression::TPZMyLambdaExpression() : fNpts(-1), fMaterial(), fPlasticStrain(0,0), fMType(0,0), fAlpha(0,0) {
}

//TPZMyLambdaExpression::TPZMyLambdaExpression(TPZElastoPlasticIntPointsStructMatrix *intPointsStructMatrix) : fNpts(-1), fMaterial(), fPlasticStrain(0,0), fMType(0,0), fAlpha(0,0), fIntPointsStructMatrix() {
